...
public Book(){
        ...
        dataperson.add(new DataPersonal("saifulloh","habib"));
        dataperson.add(new DataPersonal("abu","abu"));
        dataperson.add(new DataPersonal("do","ma"));
        dataperson.add(new DataPersonal("alif","ahmad"));
 }
